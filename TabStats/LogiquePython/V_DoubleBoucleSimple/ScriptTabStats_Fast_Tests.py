...
# from V_Multithread.project_sources.F2 import F2
# from V_Multithread.project_sources.F1 import F1
...
class TabStats():
    ...
    pathXLSX = "C:/Users/Charly/CloudStation/Projets/Perso/TabStats/TabStats/Data/"
    ############################## END DECLARATIONS #############################
...
if __name__ == '__main__':
    ...
    print(timeit("__main__()", "from __main__ import __main__", number = 1))
    print("TIMING")
